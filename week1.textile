...
If you have successfully setup the virtual environment, the output from *hostname* should be *vagrant-ubuntu*.

That is all the setup that is required at this stage in the course.  To teardown the environment, first exit from the SSH session:
