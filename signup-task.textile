...
Install JRuby using the installer available "the JRuby site":http://jruby.org/download.  Make sure to download the x64 version if you are running a 64-bit version of Windows; if not, download the plain Windows Executable.
