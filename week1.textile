...
If you have used an imperative, object-oriented language (C++, Java, C#, etc...), Ruby's syntax may look very similar.  Beware, though, Ruby has many powerful constructs that are either not present in other languages or are not as idiomatic.
